...
def generate_concentration_for_sample(log10masses, z=0.0,
    ...
    '''From the assumed true masses for a sampled population of simulated galaxy clusters at a given redshift, define the corresponding concentrations of this population assuming a mean concentration-mass relation (based on theoretical prediction) with some scatter in concentration at fixed mass. 
    Args:
    ...
    # Note: May want to generalize the distribution of concentration about the mean relation that is not random normal
