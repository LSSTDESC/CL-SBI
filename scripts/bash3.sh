...
run_config() {
	...
	python3 gen_posterior.py --sim_id $SIM_ID --infer_id $INFER_ID --num_sims $NUM_SIMS --num_obs $NUM_OBS #--regenerate
...
# run_config	"sim_z1"					"infer_z1_high_mc_scatter"	"obs_z1_lambda5_high_mc_scatter"	10000	376
# run_config	"sim_z1"					"infer_z1"					"obs_z1_lambda5_high_noise"			10000	376
# run_config	"sim_z1"					"infer_z1"					"obs_z1_lambda5_low_richness_leak"					10000	376
# run_config	"sim_z1"					"infer_z1"					"obs_z1_lambda5_high_richness_leak"					10000	376
# # ##############################
